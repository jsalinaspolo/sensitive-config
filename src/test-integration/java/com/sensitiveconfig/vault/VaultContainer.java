package com.sensitiveconfig.vault;
...
public class VaultContainer implements TestRule, TestConstants {
  ...
  public VaultContainer() {
    container = new GenericContainer("vault:0.9.1")
      ...
      .withCreateContainerCmdModifier(createContainerCmd -> ((CreateContainerCmd) createContainerCmd).withCapAdd(Capability.IPC_LOCK))
